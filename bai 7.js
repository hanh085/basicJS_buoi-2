...
var a = 1*prompt('Nhập độ dài cạnh a: '); 
var b = 1*prompt('Nhập độ dài cạnh b: '); 
var c = 1*prompt('Nhập độ dài cạnh c: '); 
...
while (Check(a) == false)
{
    a = 1*prompt('Nhập độ dài cạnh a: ');  
}
while (Check(b) == false)
{
    b = 1*prompt('Nhập độ dài cạnh b: ');  
}
while (Check(c) == false)
{
    c = 1*prompt('Nhập độ dài cạnh c: ');  
}
